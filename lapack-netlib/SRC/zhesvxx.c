...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zhesvxx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zhesvxx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zhesvxx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	integer *info)
{
    ...
    extern doublereal zla_herpvgrw_(char *, integer *, integer *, 
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
    ...
    if (*n > 0) {
	*rpvgrw = zla_herpvgrw_(uplo, n, info, &a[a_offset], lda, &af[
