...
/*  ===================================================================== */
/* Subroutine */ void zunmrq_(char *side, char *trans, integer *m, integer *n, 
	 ...
	 integer *info)
{
    ...
    integer nbmin, iinfo, i1, i2, i3, ib, nb, mi, ni;
    extern /* Subroutine */ void zunmr2_(char *, char *, integer *, integer *, 
