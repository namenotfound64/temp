	...
	integer *lwork, doublereal *rwork, integer *iwork, integer *info)
{
    ...
    integer lwork_zgebrd_mm__, lwork_zgebrd_mn__, lwork_zgebrd_nn__, 
	    lwork_zgelqf_mn__, lwork_zgeqrf_mn__;
    doublecomplex cdum[1];
    integer iscl;
    doublereal anrm;
    integer idum[1], ierr, itau, lwork_zunglq_mn__, lwork_zunglq_nn__, 
	    lwork_zungqr_mm__, lwork_zungqr_mn__, irvt, lwork_zunmbr_prc_mm__,
