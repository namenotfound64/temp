...
/*  ===================================================================== */
/* Subroutine */ void chetrs_aa_(char *uplo, integer *n, integer *nrhs, 
...
/*           Compute U**H \ B -> B    [ (U**H \P**T * B) ] */
	    ...
	    i__1 = *n - 1;
	    ctrsm_("L", "U", "C", "U", &i__1, nrhs, &c_b9, &a[(a_dim1 << 1) + 
...
/*           Compute U \ B -> B   [ U \ (T \ (U**H \P**T * B) ) ] */
	    ...
	    i__1 = *n - 1;
	    ctrsm_("L", "U", "N", "U", &i__1, nrhs, &c_b9, &a[(a_dim1 << 1) + 
		    1], lda, &b[b_dim1 + 2], ldb);
...
/*           Compute L \ B -> B    [ (L \P**T * B) ] */
	    ...
	    i__1 = *n - 1;
	    ctrsm_("L", "L", "N", "U", &i__1, nrhs, &c_b9, &a[a_dim1 + 2], 
		    lda, &b[b_dim1 + 2], ldb);
	}
...
/*           Compute (L**H \ B) -> B   [ L**H \ (T \ (L \P**T * B) ) ] */
	    ...
	    i__1 = *n - 1;
	    ctrsm_("L", "L", "C", "U", &i__1, nrhs, &c_b9, &a[a_dim1 + 2], 
		    lda, &b[b_dim1 + 2], ldb);
