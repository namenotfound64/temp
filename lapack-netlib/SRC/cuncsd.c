...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cuncsd.
f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cuncsd.
f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cuncsd.
f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/*        SUBROUTINE CUNCSD( JOBU1, JOBU2, JOBV1T, JOBV2T, TRANS, */
...
/*  ===================================================================== */
/* Subroutine */ void cuncsd_(char *jobu1, char *jobu2, char *jobv1t, char *
	jobv2t, char *trans, char *signs, integer *m, integer *p, integer *q, 
	complex *x11, integer *ldx11, complex *x12, integer *ldx12, complex *
	x21, integer *ldx21, complex *x22, integer *ldx22, real *theta, 
	complex *u1, integer *ldu1, complex *u2, integer *ldu2, complex *v1t, 
	integer *ldv1t, complex *v2t, integer *ldv2t, complex *work, integer *
	lwork, real *rwork, integer *lrwork, integer *iwork, integer *info)
{
    ...
    integer lrworkopt, ibbcsd, lorbdbworkopt;
    extern /* Subroutine */ void cunbdb_(char *, char *, integer *, integer *, 
	    integer *, complex *, integer *, complex *, integer *, complex *, 
    ...
    extern /* Subroutine */ void cunglq_(integer *, integer *, integer *, 
...
/* Computing MIN */
	...
	cuncsd_(jobv1t, jobv2t, jobu1, jobu2, transt, signst, m, q, p, &x11[
...
/*     convenient */
	...
	i__1 = *m - *p;
	i__2 = *m - *q;
	cuncsd_(jobu2, jobu1, jobv2t, jobv1t, trans, signst, m, &i__1, &i__2, 
...
/* Computing MAX */
	...
	cbbcsd_(jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q, &theta[1], &
...
/* Computing MAX */
	...
	cungqr_(&i__1, &i__2, &i__3, &u1[u1_offset], &i__4, &u1[u1_offset], &
...
/* Computing MAX */
	i__5 = 1, i__6 = *m - *q;
	i__4 = f2cmax(i__5,i__6);
	cunglq_(&i__1, &i__2, &i__3, &u1[u1_offset], &i__4, &u1[u1_offset], &
		work[1], &c_n1, &childinfo);
...
/* Computing MAX */
	...
	cunbdb_(trans, signs, m, p, q, &x11[x11_offset], ldx11, &x12[
...
/*     Transform to bidiagonal block form */
    ...
    cunbdb_(trans, signs, m, p, q, &x11[x11_offset], ldx11, &x12[x12_offset], 
...
/*     Accumulate Householder reflectors */
	...
	if (wantv1t && *q > 0) {
	    i__1 = *q - 1;
	    i__2 = *q - 1;
	    clacpy_("U", &i__1, &i__2, &x11[(x11_dim1 << 1) + 1], ldx11, &v1t[
		    (v1t_dim1 << 1) + 2], ldv1t);
	    i__1 = v1t_dim1 + 1;
	...
	if (wantv2t && *m - *q > 0) {
	    i__1 = *m - *q;
	    clacpy_("U", p, &i__1, &x12[x12_offset], ldx12, &v2t[v2t_offset], 
		    ldv2t);
	    if (*m - *p > *q) {
		i__1 = *m - *p - *q;
		i__2 = *m - *p - *q;
		clacpy_("U", &i__1, &i__2, &x22[*q + 1 + (*p + 1) * x22_dim1],
		...
		i__2 = *m - *q;
		i__3 = *m - *q;
		cunglq_(&i__1, &i__2, &i__3, &v2t[v2t_offset], ldv2t, &work[
	...
	if (wantu1 && *p > 0) {
	    ...
	    cunglq_(p, p, q, &u1[u1_offset], ldu1, &work[itaup1], &work[
		    iorglq], &lorglqwork, info);
	}
	if (wantu2 && *m - *p > 0) {
	    i__1 = *m - *p;
	    clacpy_("U", q, &i__1, &x21[x21_offset], ldx21, &u2[u2_offset], 
		    ldu2);
	    i__1 = *m - *p;
	    i__2 = *m - *p;
	    cunglq_(&i__1, &i__2, q, &u2[u2_offset], ldu2, &work[itaup2], &
		    work[iorglq], &lorglqwork, info);
	}
	if (wantv1t && *q > 0) {
	    i__1 = *q - 1;
	    i__2 = *q - 1;
	    clacpy_("L", &i__1, &i__2, &x11[x11_dim1 + 2], ldx11, &v1t[(
		    v1t_dim1 << 1) + 2], ldv1t);
	    i__1 = v1t_dim1 + 1;
	    v1t[i__1].r = 1.f, v1t[i__1].i = 0.f;
	    i__1 = *q;
	    ...
	    i__2 = *q - 1;
	    i__3 = *q - 1;
	    cungqr_(&i__1, &i__2, &i__3, &v1t[(v1t_dim1 << 1) + 2], ldv1t, &
...
/* Computing MIN */
	    ...
	    q1 = f2cmin(i__1,*m);
	    i__1 = *m - *q;
	    clacpy_("L", &i__1, p, &x12[x12_offset], ldx12, &v2t[v2t_offset], 
		    ldv2t);
	    if (*m > *p + *q) {
		i__1 = *m - *p - *q;
		i__2 = *m - *p - *q;
	    ...
	    i__2 = *m - *q;
	    i__3 = *m - *q;
	    cungqr_(&i__1, &i__2, &i__3, &v2t[v2t_offset], ldv2t, &work[
...
/*     Compute the CSD of the matrix in bidiagonal-block form */
    ...
    cbbcsd_(jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q, &theta[1], &rwork[
