...
/*  ===================================================================== */
/* Subroutine */ void csytrf_aa_2stage_(char *uplo, integer *n, complex *a, 
...
/*              T(J,J) = U(1:J,J)'*H(1:J) */
		...
		i__3 = ldtb - 1;
		cgemm_("Transpose", "NoTranspose", &kb, &kb, &i__2, &q__1, &a[
			(j * nb + 1) * a_dim1 + 1], lda, &work[nb + 1], n, &
			c_b2, &tb[td + 1 + j * nb * ldtb], &i__3);
...
/*              T(J,J) += L(J,J)*T(J,J-1)*L(J,J-1)' */
		...
		q__1.r = -1.f, q__1.i = 0.f;
		i__2 = ldtb - 1;
		cgemm_("NoTranspose", "Transpose", &kb, &kb, &nb, &q__1, &
