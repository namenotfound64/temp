...
/*  ===================================================================== */
/* Subroutine */ void csytrf_aa_(char *uplo, integer *n, complex *a, integer *
	lda, integer *ipiv, complex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ void clasyf_aa_(char *, integer *, integer *, 
	    integer *, complex *, integer *, integer *, complex *, integer *, 
	    complex *), cgemv_(char *, integer *, integer *, complex *
	    , complex *, integer *, complex *, integer *, complex *, complex *
	    , integer *), cswap_(integer *, complex *, integer *, 
...
/*        Panel factorization */
	...
	i__1 = 2 - k1;
	i__2 = *n - j;
	clasyf_aa_(uplo, &i__1, &i__2, &jb, &a[f2cmax(1,j) + (j + 1) * a_dim1], 
...
/*        Panel factorization */
	...
	i__2 = 2 - k1;
	i__1 = *n - j;
	clasyf_aa_(uplo, &i__2, &i__1, &jb, &a[j + 1 + f2cmax(1,j) * a_dim1], 
		lda, &ipiv[j + 1], &work[1], n, &work[*n * nb + 1])
		;
