...
ing factorization obtained with one of the bounded diagonal pivoting methods (f2cmax 2 interchanges) */
...
/*  ===================================================================== */
/* Subroutine */ void chetrs_rook_(char *uplo, integer *n, integer *nrhs, 
