...
/*  ===================================================================== */
/* Subroutine */ void zunmlq_(char *side, char *trans, integer *m, integer *n, 
	 ...
	 integer *info)
{
    ...
    integer nbmin, iinfo, i1, i2, i3, ib, ic, jc, nb, mi, ni;
    extern /* Subroutine */ void zunml2_(char *, char *, integer *, integer *, 
