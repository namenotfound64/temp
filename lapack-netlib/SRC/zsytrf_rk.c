...
/*  ===================================================================== */
/* Subroutine */ void zsytrf_rk_(char *uplo, integer *n, doublecomplex *a, 
	...
	integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern /* Subroutine */ void zsytf2_rk_(char *, integer *, doublecomplex *
	    , integer *, doublecomplex *, integer *, integer *);
    logical upper;
    extern /* Subroutine */ void zswap_(integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *), zlasyf_rk_(char *, integer *, 
...
/*           update columns 1:k-kb */
	    ...
	    zlasyf_rk_(uplo, &k, &nb, &kb, &a[a_offset], lda, &e[1], &ipiv[1]
		    , &work[1], &ldwork, &iinfo);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    zsytf2_rk_(uplo, &k, &a[a_offset], lda, &e[1], &ipiv[1], &iinfo);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    zlasyf_rk_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &e[k],
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    zsytf2_rk_(uplo, &i__1, &a[k + k * a_dim1], lda, &e[k], &ipiv[k],
		     &iinfo);
	    kb = *n - k + 1;
