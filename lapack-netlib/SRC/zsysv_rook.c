...
/*  ===================================================================== */
/* Subroutine */ void zsysv_rook_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, doublecomplex *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern /* Subroutine */ void zsytrf_rook_(char *, integer *, 
	    doublecomplex *, integer *, integer *, doublecomplex *, integer *,
	     integer *), zsytrs_rook_(char *, integer *, integer *, 
	    doublecomplex *, integer *, integer *, doublecomplex *, integer *,
	     integer *);
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    zsytrf_rook_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &
		    c_n1, info);
...
/*        Solve with TRS_ROOK ( Use Level 2 BLAS) */
	...
	zsytrs_rook_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset]
		, ldb, info);
