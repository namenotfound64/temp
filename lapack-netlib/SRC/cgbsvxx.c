...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgbsvxx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgbsvxx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgbsvxx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	params, complex *work, real *rwork, integer *info)
{
    ...
    /* Local variables */
    real amax;
    extern real cla_gbrpvgrw_(integer *, integer *, integer *, integer *, 
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
    ...
    *rpvgrw = cla_gbrpvgrw_(n, kl, ku, n, &ab[ab_offset], ldab, &afb[
	    afb_offset], ldafb);
