...
/*  ===================================================================== */
/* Subroutine */ void zsysv_rk_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern /* Subroutine */ void zsytrf_rk_(char *, integer *, doublecomplex *
...
/*     Test the input parameters. */
	...
	*info = -11;
	...
	if (*n == 0) {
	    ...
	    zsytrf_rk_(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1],
		     &c_n1, info);
    ...
    if (*info != 0) {
	i__1 = -(*info);
	xerbla_("ZSYSV_RK ", &i__1, (ftnlen)9);
	return;
    } else if (lquery) {
	return;
    }
...
/*     A = P*U*D*(U**T)*(P**T). */
    ...
    zsytrf_rk_(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], lwork, 
	    info);
...
/*        Solve the system A*X = B with BLAS3 solver, overwriting B with X. */
	...
	zsytrs_3_(uplo, n, nrhs, &a[a_offset], lda, &e[1], &ipiv[1], &b[
		b_offset], ldb, info);
