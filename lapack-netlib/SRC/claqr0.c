...
/* > \brief \b CLAQR0 computes the eigenvalues of a Hessenberg matrix, and optionally the matrices from the Sc
hur decomposition. */
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/claqr0.
f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/claqr0.
f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/claqr0.
f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/* > */
/*  ===================================================================== */
/* Subroutine */ void claqr0_(logical *wantt, logical *wantz, integer *n, 
	...
	work, integer *lwork, integer *info)
{
    ...
    real r__1=0., r__2=0., r__3=0., r__4=0., r__5=0., r__6=0., r__7=0., r__8=0.;
    ...
    extern /* Subroutine */ void claqr3_(logical *, logical *, integer *, 
