...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/chesvxx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/chesvxx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/chesvxx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	nparams, real *params, complex *work, real *rwork, integer *info)
{
    ...
    /* Local variables */
    real amax, smin, smax;
    extern real cla_herpvgrw_(char *, integer *, integer *, complex *, 
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
    ...
    if (*n > 0) {
	*rpvgrw = cla_herpvgrw_(uplo, n, info, &a[a_offset], lda, &af[
