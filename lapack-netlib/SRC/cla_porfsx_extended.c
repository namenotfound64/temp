...
/* > \brief \b CLA_PORFSX_EXTENDED improves the computed solution to a system of linear equations for symmetri
...
/*  ===================================================================== */
/* Subroutine */ void cla_porfsx_extended_(integer *prec_type__, char *uplo, 
	...
	rthresh, real *dz_ub__, logical *ignore_cwise__, integer *info)
{
    ...
    extern /* Subroutine */ void cpotrs_(char *, integer *, integer *, complex 
...
/*         XXX: RES is no longer needed. */
	    ...
	    cpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &dy[1], n, info);
...
/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */
	...
	cla_heamv_(&uplo2, n, &c_b34, &a[a_offset], lda, &y[j * y_dim1 + 1], 
