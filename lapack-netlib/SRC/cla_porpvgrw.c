...
/*  ===================================================================== */
real cla_porpvgrw_(char *uplo, integer *ncols, complex *a, integer *lda, 
	complex *af, integer *ldaf, real *work)
{
...
/* Computing MAX */
		...
		r__3 = (r__1 = a[i__3].r, abs(r__1)) + (r__2 = r_imag(&a[i__ 
			+ j * a_dim1]), abs(r__2)), r__4 = work[*ncols + j];
		work[*ncols + j] = f2cmax(r__3,r__4);
	    }
	}
    } else {
	i__1 = *ncols;
...
/* Computing MAX */
		i__3 = i__ + j * af_dim1;
		r__3 = (r__1 = af[i__3].r, abs(r__1)) + (r__2 = r_imag(&af[
			i__ + j * af_dim1]), abs(r__2)), r__4 = work[j];
		work[j] = f2cmax(r__3,r__4);
	    }
	}
    } else {
	i__1 = *ncols;
