...
/* > \brief \b CSYTRF_RK computes the factorization of a complex symmetric indefinite matrix using the bounded
...
/* Computing MAX */
	    ...
	    nb = f2cmax(i__1,1);
/* Computing MAX */
	    i__1 = 2, i__2 = ilaenv_(&c__2, "CSYTRF_RK", uplo, n, &c_n1, &
...
/*           update columns 1:k-kb */
	    ...
	    clasyf_rk_(uplo, &k, &nb, &kb, &a[a_offset], lda, &e[1], &ipiv[1]
		    , &work[1], &ldwork, &iinfo);
	} else {
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    clasyf_rk_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &e[k],
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    csytf2_rk_(uplo, &i__1, &a[k + k * a_dim1], lda, &e[k], &ipiv[k],
		     &iinfo);
	    kb = *n - k + 1;
