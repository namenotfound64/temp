...
/*  ===================================================================== */
real cla_gbrpvgrw_(integer *n, integer *kl, integer *ku, integer *ncols, 
	complex *ab, integer *ldab, complex *afb, integer *ldafb)
{
...
/* Computing MAX */
	    ...
	    r__3 = (r__1 = ab[i__2].r, abs(r__1)) + (r__2 = r_imag(&ab[kd + 
		    i__ - j + j * ab_dim1]), abs(r__2));
	    amax = f2cmax(r__3,amax);
	}
/* Computing MAX */
	i__3 = j - *ku;
	i__2 = j;
...
/* Computing MAX */
	    ...
	    r__3 = (r__1 = afb[i__3].r, abs(r__1)) + (r__2 = r_imag(&afb[kd + 
		    i__ - j + j * afb_dim1]), abs(r__2));
	    umax = f2cmax(r__3,umax);
	}
	if (umax != 0.f) {
/* Computing MIN */
	    r__1 = amax / umax;
