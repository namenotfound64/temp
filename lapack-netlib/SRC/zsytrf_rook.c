...
/*        Determine the block size */
	...
	nb = ilaenv_(&c__1, "ZSYTRF_ROOK", uplo, n, &c_n1, &c_n1, &c_n1, (
		ftnlen)11, (ftnlen)1);
/* Computing MAX */
	i__1 = 1, i__2 = *n * nb;
...
/* Computing MAX */
	    ...
	    nb = f2cmax(i__1,1);
/* Computing MAX */
	    i__1 = 2, i__2 = ilaenv_(&c__2, "ZSYTRF_ROOK", uplo, n, &c_n1, &
...
/*           update columns 1:k-kb */
	    ...
	    zlasyf_rook_(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &
		    work[1], &ldwork, &iinfo);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    zsytf2_rook_(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    zlasyf_rook_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    zsytf2_rook_(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &
		    iinfo);
	    kb = *n - k + 1;
	}
