...
/* > */
/*  ===================================================================== */
/* Subroutine */ void cunbdb3_(integer *m, integer *p, integer *q, complex *
...
/*     Reduce rows 1, ..., M-P of X11 and X21 */
	...
	i__2 = *p - i__ + 1;
/* Computing 2nd power */
	r__1 = scnrm2_(&i__2, &x11[i__ + i__ * x11_dim1], &c__1);
	i__3 = *m - *p - i__;
/* Computing 2nd power */
	...
	if (i__ < *m - *p) {
	    ...
	    phi[i__] = atan2((real) x21[i__ + 1 + i__ * x21_dim1].r, (real) 
		    x11[i__ + i__ * x11_dim1].r);
	    c__ = cos(phi[i__]);
	    s = sin(phi[i__]);
	    ...
	    clarf_("L", &i__2, &i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1, &
		    q__1, &x21[i__ + 1 + (i__ + 1) * x21_dim1], ldx21, &work[
		    ilarf]);
	}
