...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zsysvxx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zsysvxx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zsysvxx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/*  ===================================================================== */
/* Subroutine */ void zsysvxx_(char *fact, char *uplo, integer *n, integer *
	...
	integer *info)
{
    ...
    /* Local variables */
    extern /* Subroutine */ void zsyrfsx_(char *, char *, integer *, integer *,
    ...
    doublereal scond;
    extern doublereal zla_syrpvgrw_(char *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, integer *,
	     doublereal *);
    logical equil, rcequ;
    ...
    doublereal smlnum;
    extern /* Subroutine */ void zlaqsy_(char *, integer *, doublecomplex *, 
...
/*           leading rank-deficient INFO columns of A. */
	    ...
	    if (*n > 0) {
		*rpvgrw = zla_syrpvgrw_(uplo, n, info, &a[a_offset], lda, &
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
    ...
    if (*n > 0) {
	*rpvgrw = zla_syrpvgrw_(uplo, n, info, &a[a_offset], lda, &af[
		af_offset], ldaf, &ipiv[1], &rwork[1]);
    }
