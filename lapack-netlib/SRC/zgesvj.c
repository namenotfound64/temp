...
/* > \param[in,out] CWORK */
/* > \verbatim */
/* >          CWORK is COMPLEX*16 array, dimension (f2cmax(1,LWORK)) */
/* >          Used as workspace. */
...
/* > \param[in,out] RWORK */
/* > \verbatim */
/* >          RWORK is DOUBLE PRECISION array, dimension (f2cmax(6,LRWORK)) */
/* >          On entry, */
/* >          If JOBU = 'C' : */
	...
	lwork, doublereal *rwork, integer *lrwork, integer *info)
{
    ...
    extern /* Subroutine */ void zgsvj0_(char *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, doublereal *, 
	    integer *, doublecomplex *, integer *, doublereal *, doublereal *,
	     doublereal *, integer *, doublecomplex *, integer *, integer *), zgsvj1_(char *, integer *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, doublereal *, 
	    integer *, doublecomplex *, integer *, doublereal *, doublereal *,
