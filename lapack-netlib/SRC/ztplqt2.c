...
/* > \brief \b ZTPLQT2 computes a LQ factorization of a real or complex "triangular-pentagonal" matrix, which 
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ztplqt2
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ztplqt2
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ztplqt2
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/* > */
/*  ===================================================================== */
/* Subroutine */ void ztplqt2_(integer *m, integer *n, integer *l, 
...
/*        Generate elementary reflector H(I) to annihilate B(I,:) */
	...
	p = *n - *l + f2cmin(*l,i__);
	i__2 = p + 1;
	zlarfg_(&i__2, &a[i__ + i__ * a_dim1], &b[i__ + b_dim1], ldb, &t[i__ *
		 t_dim1 + 1]);
	i__2 = i__ * t_dim1 + 1;
...
/*           W(M-I:1) := C(I+1:M,I:N) * C(I,I:N) [use W = T(M,:)] */
	    ...
	    i__2 = *m - i__;
	    zgemv_("N", &i__2, &p, &c_b2, &b[i__ + 1 + b_dim1], ldb, &b[i__ + 
		    b_dim1], ldb, &c_b2, &t[*m + t_dim1], ldt);
...
/*           C(I+1:M,I:N) = C(I+1:M,I:N) + alpha * C(I,I:N)*W(M-1:1)^H */
	    ...
	    zgerc_(&i__2, &p, &z__1, &t[*m + t_dim1], ldt, &b[i__ + b_dim1], 
...
/*        Triangular part of B2 */
	...
	ztrmv_("L", "N", "N", &p, &b[np * b_dim1 + 1], ldb, &t[i__ + t_dim1], 
		ldt);

/*        Rectangular part of B2 */

	i__2 = i__ - 1 - p;
	zgemv_("N", &i__2, l, &alpha, &b[mp + np * b_dim1], ldb, &b[i__ + np *
		 b_dim1], ldb, &c_b1, &t[i__ + mp * t_dim1], ldt);

/*        B1 */

	i__2 = i__ - 1;
	i__3 = *n - *l;
	zgemv_("N", &i__2, &i__3, &alpha, &b[b_offset], ldb, &b[i__ + b_dim1],
		 ldb, &c_b2, &t[i__ + t_dim1], ldt);
