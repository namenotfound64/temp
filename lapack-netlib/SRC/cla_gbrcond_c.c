...
/*  ===================================================================== */
real cla_gbrcond_c_(char *trans, integer *n, integer *kl, integer *ku, 
...
/* Computing MIN */
		...
		for (j = f2cmax(i__2,1); j <= i__3; ++j) {
		    ...
		    tmp += ((r__1 = ab[i__2].r, abs(r__1)) + (r__2 = r_imag(&
			    ab[kd + i__ - j + j * ab_dim1]), abs(r__2))) / 
			    c__[j];
		}
	    } else {
/* Computing MAX */
...
/* Computing MIN */
		...
		for (j = f2cmax(i__3,1); j <= i__2; ++j) {
		    ...
		    tmp += (r__1 = ab[i__3].r, abs(r__1)) + (r__2 = r_imag(&
			    ab[kd + i__ - j + j * ab_dim1]), abs(r__2));
		}
	    }
	    rwork[i__] = tmp;
...
/* Computing MIN */
		...
		for (j = f2cmax(i__2,1); j <= i__3; ++j) {
		    ...
		    tmp += ((r__1 = ab[i__2].r, abs(r__1)) + (r__2 = r_imag(&
			    ab[ke - i__ + j + i__ * ab_dim1]), abs(r__2))) / 
			    c__[j];
		}
	    } else {
/* Computing MAX */
