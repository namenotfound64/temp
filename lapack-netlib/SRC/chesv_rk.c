...
/*  ===================================================================== */
/* Subroutine */ void chesv_rk_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, complex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ void chetrf_rk_(char *, integer *, complex *, 
	    integer *, complex *, integer *, complex *, integer *, integer *);
    extern int xerbla_(char *, integer *, ftnlen);
    integer lwkopt;
    logical lquery;
    extern /* Subroutine */ void chetrs_3_(char *, integer *, integer *, 
