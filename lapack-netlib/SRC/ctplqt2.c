...
/* > */
/*  ===================================================================== */
/* Subroutine */ void ctplqt2_(integer *m, integer *n, integer *l, complex *a, 
...
/*           C(I+1:M,I:N) = C(I+1:M,I:N) + alpha * C(I,I:N)*W(M-1:1)^H */
		...
		i__4 = i__ + j + i__ * a_dim1;
		i__5 = *m + j * t_dim1;
		q__2.r = alpha.r * t[i__5].r - alpha.i * t[i__5].i, q__2.i = 
	    ...
	    cgerc_(&i__2, &p, &q__1, &t[*m + t_dim1], ldt, &b[i__ + b_dim1], 
...
/*        Triangular part of B2 */
	...
	for (j = 1; j <= i__2; ++j) {
	    ...
	    q__1.r = alpha.r * b[i__4].r - alpha.i * b[i__4].i, q__1.i = 
