...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zlaunhr
_col_getrfnp2.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zlaunhr
_col_getrfnp2.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zlaunhr
_col_getrfnp2.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/* > \param[out] D */
/* > \verbatim */
/* >          D is COMPLEX*16 array, dimension f2cmin(M,N) */
...
/*        Transfer the sign */
	...
	d__[1].r = z__1.r, d__[1].i = z__1.i;

/*        Construct the row of U */

	i__1 = a_dim1 + 1;
	i__2 = a_dim1 + 1;
	z__1.r = a[i__2].r - d__[1].r, z__1.i = a[i__2].i - d__[1].i;
...
/*        Construct the subdiagonal elements of L */
	...
	i__1 = a_dim1 + 1;
	if ((d__1 = a[i__1].r, abs(d__1)) + (d__2 = d_imag(&a[a_dim1 + 1]), 
		abs(d__2)) >= sfmin) {
	    i__1 = *m - 1;
...
/*        Solve for B21 */
	...
	i__1 = *m - n1;
	ztrsm_("R", "U", "N", "N", &i__1, &n1, &c_b1, &a[a_offset], lda, &a[
		n1 + 1 + a_dim1], lda);
...
/*        Factor B22, recursive call */
	...
	i__1 = *m - n1;
	zlaunhr_col_getrfnp2_(&i__1, &n2, &a[n1 + 1 + (n1 + 1) * a_dim1], 
		lda, &d__[n1 + 1], &iinfo);
