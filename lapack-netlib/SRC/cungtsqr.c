...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cuntsqr
.f"> */
/* > [TGZ]</a> */
...
/*           On output, WORK(1:LDC*N) stores Q1_in. */
    ...
    clamtsqr_("L", "N", m, n, n, mb, &nblocal, &a[a_offset], lda, &t[t_offset]
