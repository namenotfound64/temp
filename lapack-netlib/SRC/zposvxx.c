...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zposvxx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zposvxx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zposvxx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	doublecomplex *work, doublereal *rwork, integer *info)
{
    ...
    integer j;
    extern doublereal zla_porpvgrw_(char *, integer *, doublecomplex *, 
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
    ...
    *rpvgrw = zla_porpvgrw_(uplo, n, &a[a_offset], lda, &af[af_offset], ldaf,
	     &rwork[1]);
