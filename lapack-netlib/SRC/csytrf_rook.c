...
/*  ===================================================================== */
/* Subroutine */ void csytrf_rook_(char *uplo, integer *n, complex *a, 
	...
	info)
{
    ...
    logical lquery;
    integer iws;
    extern /* Subroutine */ void csytf2_rook_(char *, integer *, complex *, 
	    integer *, integer *, integer *), clasyf_rook_(char *, 
...
/*        Determine the block size */
	...
	nb = ilaenv_(&c__1, "CSYTRF_ROOK", uplo, n, &c_n1, &c_n1, &c_n1, (
		ftnlen)11, (ftnlen)1);
/* Computing MAX */
	i__1 = 1, i__2 = *n * nb;
    ...
    if (*info != 0) {
	i__1 = -(*info);
	xerbla_("CSYTRF_ROOK", &i__1, (ftnlen)11);
	return;
    } else if (lquery) {
	return;
    }
...
/* Computing MAX */
	    ...
	    nb = f2cmax(i__1,1);
/* Computing MAX */
	    i__1 = 2, i__2 = ilaenv_(&c__2, "CSYTRF_ROOK", uplo, n, &c_n1, &
...
/*           update columns 1:k-kb */
	    ...
	    clasyf_rook_(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &
		    work[1], &ldwork, &iinfo);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    csytf2_rook_(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    clasyf_rook_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    csytf2_rook_(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &
		    iinfo);
	    kb = *n - k + 1;
	}
