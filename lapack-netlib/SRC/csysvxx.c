...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/csysvxx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/csysvxx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/csysvxx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/*  ===================================================================== */
/* Subroutine */ void csysvxx_(char *fact, char *uplo, integer *n, integer *
	...
	nparams, real *params, complex *work, real *rwork, integer *info)
{
    ...
    real amax, smin, smax;
    integer j;
    extern real cla_syrpvgrw_(char *, integer *, integer *, complex *, 
    ...
    real bignum;
    integer infequ;
    extern /* Subroutine */ void claqsy_(char *, integer *, complex *, integer 
...
/*           leading rank-deficient INFO columns of A. */
	    ...
	    if (*n > 0) {
		*rpvgrw = cla_syrpvgrw_(uplo, n, info, &a[a_offset], lda, &
...
/*     Compute the reciprocal pivot growth factor RPVGRW. */
    ...
    if (*n > 0) {
	*rpvgrw = cla_syrpvgrw_(uplo, n, info, &a[a_offset], lda, &af[
