...
/*  ===================================================================== */
/* Subroutine */ void cla_syrfsx_extended_(integer *prec_type__, char *uplo, 
	...
	integer *info)
{
    ...
    extern /* Subroutine */ void cla_lin_berr_(integer *, integer *, integer *
	    , complex *, real *, real *);
    real ymin, dxratmax, dzratmax;
    integer y_prec_state__;
    extern /* Subroutine */ void blas_csymv_x_(integer *, integer *, complex *
	    , complex *, integer *, complex *, integer *, complex *, complex *
	    , integer *, integer *);
    integer uplo2, i__, j;
    extern logical lsame_(char *, char *);
    extern /* Subroutine */ void blas_csymv2_x_(integer *, integer *, complex 
    ...
    extern /* Subroutine */ void caxpy_(integer *, complex *, complex *, 
	    integer *, complex *, integer *);
    logical upper;
    extern /* Subroutine */ void cla_syamv_(integer *, integer *, real *, 
	    complex *, integer *, complex *, integer *, real *, real *, 
	    integer *), csymv_(char *, integer *, complex *, complex *, 
...
/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */
	...
	cla_syamv_(&uplo2, n, &c_b37, &a[a_offset], lda, &y[j * y_dim1 + 1], 
