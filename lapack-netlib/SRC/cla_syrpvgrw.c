...
/*  ===================================================================== */
real cla_syrpvgrw_(char *uplo, integer *n, integer *info, complex *a, 
...
/* Computing MAX */
		i__3 = i__ + j * a_dim1;
		r__3 = (r__1 = a[i__3].r, abs(r__1)) + (r__2 = r_imag(&a[i__ 
			+ j * a_dim1]), abs(r__2)), r__4 = work[*n + i__];
		work[*n + i__] = f2cmax(r__3,r__4);
/* Computing MAX */
		i__3 = i__ + j * a_dim1;
		r__3 = (r__1 = a[i__3].r, abs(r__1)) + (r__2 = r_imag(&a[i__ 
			+ j * a_dim1]), abs(r__2)), r__4 = work[*n + j];
		work[*n + j] = f2cmax(r__3,r__4);
	    }
	}
    } else {
	i__1 = *n;
...
/* Computing MAX */
		    i__2 = i__ + k * af_dim1;
		    r__3 = (r__1 = af[i__2].r, abs(r__1)) + (r__2 = r_imag(&
			    af[i__ + k * af_dim1]), abs(r__2)), r__4 = work[k]
			    ;
		    work[k] = f2cmax(r__3,r__4);
		}
		--k;
	    } else {
/*              2x2 pivot */
...
/* Computing MAX */
		    ...
		    r__3 = (r__1 = af[i__2].r, abs(r__1)) + (r__2 = r_imag(&
			    af[i__ + (k - 1) * af_dim1]), abs(r__2)), r__4 = 
			    work[k - 1];
		    work[k - 1] = f2cmax(r__3,r__4);
		}
/* Computing MAX */
		i__1 = k + k * af_dim1;
		r__3 = (r__1 = af[i__1].r, abs(r__1)) + (r__2 = r_imag(&af[k 
			+ k * af_dim1]), abs(r__2)), r__4 = work[k];
		work[k] = f2cmax(r__3,r__4);
		k += -2;
	    }
	}
