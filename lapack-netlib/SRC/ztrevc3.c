...
/*               REMAX = ONE / CABS1( VR( II, IS ) ) */
		remax = 1. / z_abs(&vr[ii + is * vr_dim1]);
...
/*               REMAX = ONE / CABS1( VR( II, KI ) ) */
		remax = 1. / z_abs(&vr[ii + ki * vr_dim1]);
...
/*               REMAX = ONE / CABS1( VL( II, IS ) ) */
		remax = 1. / z_abs(&vl[ii + is * vl_dim1]);
		i__3 = *n - ki + 1;
...
/*               REMAX = ONE / CABS1( VL( II, KI ) ) */
		remax = 1. / z_abs(&vl[ii + ki * vl_dim1]);
